"""
Prof. Maya People – Team & Talent Strategy (Chapters 4-6).
...
class ProfPeople(BaseProfessor):
    agent_id       = "people"
    professor_name = "Prof. Maya People"
    ...
    async def respond(self, packet: HandoffPacket2) -> ProfessorResponse:
        return ProfessorResponse(
            response_text=(
                "Prof. Maya People's domain (Team & Talent Strategy, chapters 4-6) "
